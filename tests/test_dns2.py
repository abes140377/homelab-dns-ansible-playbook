...
# Configure testinfra to use ansible backend for dns2
testinfra_hosts = ["ansible://dns2"]
...
@pytest.mark.parametrize("service_name", ["bind9"])
...
def test_bind9_host_ip():
    host_ip = get_host_ip("dns2")
    assert host_ip == "192.168.1.14"
